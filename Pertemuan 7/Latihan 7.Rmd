---
title: "Tugas Praktikum Minggu 7 Metode Peramalan Deret Waktu"
...
```
Berdasarkan plot data deret waktu di atas, terlihat bahwa data cenderung memiliki trend yang naik turun yang menunjukkan data tidak stasioner dalam rataan dan ragam, ditandai dengan adanya lebar pita pada plot yang cenderung berbeda. Berdasarkan pola data, pembagian data latih dan data uji ditetapkan dengan proporsi 72%:28%.
...
Berdasarkan uji-ttersebut, didapat *p-value* sebesar 0.6774 yang lebih besar dari taraf nyata 5% sehingga tidak tolak $H_0$ dan menandakan bahwa nilai tengah sisaan sama dengan nol.Hal ini sesuai dengan eksplorasi.
