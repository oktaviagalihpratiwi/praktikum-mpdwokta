...
```{r}
library(readxl)
data_aqi <- read_xlsx("C:/Users/oktav/Downloads/KULIAH/SEMESTER 5/METODE PERAMALAN DERET WAKTU/praktikum-mpdwokta/data_aqi.xlsx")
str(data_aqi)
data_aqi
```
```{r}
